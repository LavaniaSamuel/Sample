...
class SmashTweeterTableViewController: FetchedResultsTableViewController
{
    ...
    var fetchedResultsController: NSFetchedResultsController<TweetUser>?
    ...
    private func updateUI() {
        if let context = container?.viewContext, mention != nil {
            ...
            fetchedResultsController = NSFetchedResultsController<TweetUser>(
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Tweeter Cell", for: indexPath)
    ...
    private func tweetCountWithMentionBy(_ twitterUser: TweetUser) ->Int {
