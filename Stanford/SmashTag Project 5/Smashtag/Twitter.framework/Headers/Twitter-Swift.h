...
@property (nonatomic, readonly, copy) NSString * _Nullable searchTerm;
...
- (void)fetch:(void (^ _Nonnull)(id _Nullable))handler;
@property (nonatomic, readonly, strong) Request * _Nullable older;
@property (nonatomic, readonly, strong) Request * _Nullable newer;
